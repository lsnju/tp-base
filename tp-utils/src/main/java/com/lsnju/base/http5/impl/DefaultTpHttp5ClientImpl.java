package com.lsnju.base.http5.impl;
 ...
 * @version V1.0
 */
public class DefaultTpHttp5ClientImpl implements TpHttp5Client {
    ...
    @Override
    public ClassicHttpResponse postXml(String targetUrl, String rawReq, Http5RequestCustomizer customizer) throws IOException {
        return postXml(URI.create(targetUrl), rawReq, customizer);
    }

    @Override
    public ClassicHttpResponse postXml(String targetUrl, String rawReq, Http5RequestCustomizer customizer, Executor executor) throws IOException {
    ...
    public ClassicHttpResponse postXml(URI targetUrl, String rawReq) throws IOException {
        return postXml(targetUrl, rawReq, Http5RequestCustomizer.NO_OP, null);
    }

    @Override
    public ClassicHttpResponse postXml(URI targetUrl, String rawReq, Http5RequestCustomizer customizer) throws IOException {
    ...
    public ClassicHttpResponse postXml(URI targetUrl, String rawReq, Executor executor) throws IOException {
        return postXml(targetUrl, rawReq, Http5RequestCustomizer.NO_OP, executor);
    }

    @Override
    public ClassicHttpResponse postXml(URI targetUrl, String rawReq, Http5RequestCustomizer customizer, Executor executor) throws IOException {
    ...
    @Override
    public ClassicHttpResponse postJson(String targetUrl, String rawReq, Http5RequestCustomizer customizer) throws IOException {
    ...
    @Override
    public ClassicHttpResponse postJson(String targetUrl, String rawReq, Http5RequestCustomizer customizer, Executor executor) throws IOException {
    ...
    public ClassicHttpResponse postJson(URI targetUrl, String rawReq) throws IOException {
        return postJson(targetUrl, rawReq, Http5RequestCustomizer.NO_OP, null);
    }

    @Override
    public ClassicHttpResponse postJson(URI targetUrl, String rawReq, Http5RequestCustomizer customizer) throws IOException {
    ...
    public ClassicHttpResponse postJson(URI targetUrl, String rawReq, Executor executor) throws IOException {
        return postJson(targetUrl, rawReq, Http5RequestCustomizer.NO_OP, executor);
    }

    @Override
    public ClassicHttpResponse postJson(URI targetUrl, String rawReq, Http5RequestCustomizer customizer, Executor executor) throws IOException {
    ...
    @Override
    public ClassicHttpResponse post(String targetUrl, String rawReq, ContentType contentType, Http5RequestCustomizer customizer, Executor executor) throws IOException {
    ...
    public ClassicHttpResponse post(URI targetUrl, String rawReq, ContentType contentType, Executor executor) throws IOException {
        return post(targetUrl, rawReq, contentType, Http5RequestCustomizer.NO_OP, executor);
    }

    @Override
    public ClassicHttpResponse post(URI targetUrl, String rawReq, ContentType contentType, Http5RequestCustomizer customizer, Executor executor) throws IOException {
    ...
    @Override
    public ClassicHttpResponse get(String targetUrl, Http5RequestCustomizer customizer) throws IOException {
    ...
    @Override
    public ClassicHttpResponse get(String targetUrl, Http5RequestCustomizer customizer, Executor executor) throws IOException {
        return get(URI.create(targetUrl), customizer, executor);
    }

    @Override
    public ClassicHttpResponse get(URI targetUrl) throws IOException {
        return get(targetUrl, Http5RequestCustomizer.NO_OP, null);
    }

    @Override
    public ClassicHttpResponse get(URI targetUrl, Http5RequestCustomizer customizer) throws IOException {
    ...
    public ClassicHttpResponse get(URI targetUrl, Executor executor) throws IOException {
        return get(targetUrl, Http5RequestCustomizer.NO_OP, executor);
    }
